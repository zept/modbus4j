 ...
 * @version 5.0.0
 */
public class ReadRegisterDescriptionRequest extends ReadNumericRequest {
    /**
     ...
     */
    public ReadRegisterDescriptionRequest(int slaveId, int startOffset, int numberOfRegisters)
            throws ModbusTransportException {
        super(slaveId, startOffset, numberOfRegisters);
    }

    ReadRegisterDescriptionRequest(int slaveId) throws ModbusTransportException {
        super(slaveId);
    }
